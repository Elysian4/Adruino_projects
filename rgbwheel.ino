...
SoftwareSerial btSerial(11,10);                         //instance used for bluetooth communication
int redPin=3;
                                                        //defining values
int greenPin=5;                             
int bluePin=6;
...
void loop(){
  if(btSerial.available()){
      ...
      b_value=blue.toInt();
                                                         ...
                                                         //analog output part
      analogWrite(redPin,r_value);                       //Sets the intensity of the red
      analogWrite(greenPin,g_value);                     //Sets the intensity of the green
      analogWrite(bluePin,b_value);                      //Sets the intensity of the blue
